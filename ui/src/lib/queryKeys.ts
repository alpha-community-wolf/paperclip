export const queryKeys = {
  ...
  issues: {
    ...
    paged: (companyId: string, filters?: Record<string, string | undefined>) =>
      ["issues", companyId, "paged", filters] as const,
  ...
  chatUnreadSummary: (companyId: string) => ["chat", "unread-summary", companyId] as const,
