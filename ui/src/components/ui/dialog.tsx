...
import { ModalPortalRootContext } from "@/context/ModalPortalRootContext"
...
function DialogContent({
  ...
  const [modalPortalRoot, setModalPortalRoot] = React.useState<HTMLElement | null>(null)
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        {...props}
      >
        <ModalPortalRootContext.Provider value={modalPortalRoot}>
          {children}
          {showCloseButton && (
